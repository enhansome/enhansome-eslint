...
* [es-x](https://github.com/eslint-community/eslint-plugin-es-x) ⭐ 156 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-25 - Disable specific ECMAScript language versions or individual features. Properly maintained fork of no longer maintained `eslint-plugin-es`.
...
* [YAML](https://github.com/ota-meshi/eslint-plugin-yml) ⭐ 186 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-25 - ESLint plugin for YAML.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 54 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-26 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 13 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-26 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,926 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-26 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,250 | 🐛 2,410 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
