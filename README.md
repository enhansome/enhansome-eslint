...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,272 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,272 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,518 | 🐛 127 | 🌐 JavaScript | 📅 2026-09-25 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 5,251 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-25 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,293 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-25 - Rules detecting bugs and suspicious patterns.
...
* [es-x](https://github.com/eslint-community/eslint-plugin-es-x) ⭐ 156 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-25 - Disable specific ECMAScript language versions or individual features. Properly maintained fork of no longer maintained `eslint-plugin-es`.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 33 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-31 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,429 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-25 styles.
* Styled Components
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 580 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-25 - Linting for JavaScript inside of Markdown.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,806 | 🐛 330 | 🌐 JavaScript | 📅 2026-09-25 - Meteor specific linting rules for ESLint.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,785 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-24 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 620 | 🐛 74 | 🌐 JavaScript | 📅 2026-07-12 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,608 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 250,712 | 🐛 1,378 | 🌐 JavaScript | 📅 2026-09-25 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,293 | 🐛 374 | 🌐 JavaScript | 📅 2026-07-30 - Linting rules for React and JSX.
...
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,589 | 🐛 204 | 🌐 TypeScript | 📅 2026-09-24 - Plugin for VueJS.
  * [VueJS Scoped CSS](https://github.com/future-architect/eslint-plugin-vue-scoped-css) ⭐ 109 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-24 - Plugin for Scoped CSS in VueJS.

### Languages and Environments

* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 44,018 | 🐛 770 | 🌐 TypeScript | 📅 2026-09-25 - Adds replacements for built-in rules to include Babel features.
...
* [YAML](https://github.com/ota-meshi/eslint-plugin-yml) ⭐ 186 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-25 - ESLint plugin for YAML.
...
* JSON
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 261 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-24 - Rules for consistent, readable, and valid package.json files.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 120 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-25 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 54 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-24 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* GraphQL
  * [apollostack/eslint-plugin-graphql](https://github.com/apollostack/eslint-plugin-graphql) ⭐ 1,215 | 🐛 101 | 🌐 JavaScript | 📅 2026-09-25 - Check your GraphQL query strings against a schema.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 991 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-25 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
...
* [Promise](https://github.com/xjamundx/eslint-plugin-promise) ⭐ 1,003 | 🐛 52 | 🌐 JavaScript | 📅 2026-09-24 - Best practices when working with promises.
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 779 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-25 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [no-comments](https://github.com/wisniewski94/eslint-plugin-no-comments) ⭐ 18 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-08 - Prevents leaking comments into production if bundler is not used and stops developers from commenting out old lines of code.
* [this](https://github.com/matijs/eslint-plugin-this) ⭐ 16 | 🐛 0 | 🌐 JavaScript | 📅 2023-03-09 - Write pure functions, don't allow `this`.
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 13 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-25 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [Simple import sort](https://github.com/lydell/eslint-plugin-simple-import-sort) ⭐ 2,459 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-03 - Easy autofixable import sorting.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,064 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-25 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 729 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-24 - Linting rules for Cypress.
...
* Chai
  ...
  * [expect practices](https://github.com/turbo87/eslint-plugin-chai-expect) ⭐ 29 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-24
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,174 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-24 - Linting rules for Jest.
...
* Vitest
  * [ESLint Plugin Vitest](https://github.com/vitest-dev/eslint-plugin-vitest) ⭐ 510 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-19 - ESLint plugin for Vitest.
* Mocha
  * [Enforcing practices](https://github.com/lo1tuma/eslint-plugin-mocha) ⭐ 289 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-25 - Linting rules for Mocha.
  * [Enforcing manageability](https://github.com/onechiporenko/eslint-plugin-mocha-cleanup/) ⭐ 13 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-20

## Parsers

* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 44,018 | 🐛 770 | 🌐 TypeScript | 📅 2026-09-25 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,250 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [generator-eslint](https://github.com/eslint/generator-eslint) ⭐ 246 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-24 - Generate ESLint
...
* [eslint-doc-generator](https://github.com/bmish/eslint-doc-generator) ⭐ 113 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-24 - Generate documentation for your ESLint plugin including a rules table for your readme and header for your rule docs.
