...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,260 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,260 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,515 | 🐛 127 | 🌐 JavaScript | 📅 2026-09-23 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,644 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-19 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,435 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 284 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-23 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,988 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-18.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 5,250 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-23 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,293 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-24 - Rules detecting bugs and suspicious patterns.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 33 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-31 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,429 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-23 styles.
* Styled Components
...
* [HTML](https://github.com/BenoitZugmeyer/eslint-plugin-html) ⭐ 458 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-23 - Linting for JavaScript inside of HTML `<script>` tags.

### Frameworks

* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,807 | 🐛 330 | 🌐 JavaScript | 📅 2026-09-24 - Meteor specific linting rules for ESLint.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,785 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-24 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 620 | 🐛 74 | 🌐 JavaScript | 📅 2026-07-12 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,609 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30.
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 408 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-20 - Linting rules for Svelte v3 Components.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 250,680 | 🐛 1,377 | 🌐 JavaScript | 📅 2026-09-22 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,291 | 🐛 373 | 🌐 JavaScript | 📅 2026-07-30 - Linting rules for React and JSX.
...
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,589 | 🐛 205 | 🌐 TypeScript | 📅 2026-09-24 - Plugin for VueJS.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 44,012 | 🐛 768 | 🌐 TypeScript | 📅 2026-09-18 - Adds replacements for built-in rules to include Babel features.
...
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 273 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-24 - ESLint plugin for HTML.
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 235 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-23 - An ESLint plugin for linting ESLint plugins.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 54 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-24 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* GraphQL
  * [apollostack/eslint-plugin-graphql](https://github.com/apollostack/eslint-plugin-graphql) ⭐ 1,215 | 🐛 101 | 🌐 JavaScript | 📅 2026-09-24 - Check your GraphQL query strings against a schema.
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-23 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-23 linter into ESLint.
...
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 769 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-20 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 779 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-20 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,926 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-24 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
* [Simple import sort](https://github.com/lydell/eslint-plugin-simple-import-sort) ⭐ 2,459 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-03 - Easy autofixable import sorting.
...
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 729 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-24 - Linting rules for Cypress.
...
* Vitest
  * [ESLint Plugin Vitest](https://github.com/vitest-dev/eslint-plugin-vitest) ⭐ 509 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-19 - ESLint plugin for Vitest.
* Mocha
  * [Enforcing practices](https://github.com/lo1tuma/eslint-plugin-mocha) ⭐ 289 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-24 - Linting rules for Mocha.
  * [Enforcing manageability](https://github.com/onechiporenko/eslint-plugin-mocha-cleanup/) ⭐ 13 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-20

## Parsers

* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 44,012 | 🐛 768 | 🌐 TypeScript | 📅 2026-09-18 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [generator-eslint](https://github.com/eslint/generator-eslint) ⭐ 246 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-23 - Generate ESLint
...
* [eslint-multiplexer](https://github.com/pimlie/eslint-multiplexer) ⭐ 8 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-24 - Multiplex eslint results and merge results for common files.
