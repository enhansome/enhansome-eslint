...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,262 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,262 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,520 | 🐛 127 | 🌐 JavaScript | 📅 2026-09-23 - Contains the ESLint configuration used for projects maintained by the ESLint team.
* [Alloy](https://github.com/AlloyTeam/eslint-config-alloy) ⭐ 2,626 | 🐛 10 | 🌐 JavaScript | 📅 2024-01-11 - Progressive ESLint config for your React/Vue/TypeScript projects.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,269 | 🐛 56 | 🌐 JavaScript | 📅 2026-09-02 - Anthony's ESLint config preset.
...
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 284 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-19 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,988 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-18.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 5,248 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-22 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,291 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-23 - Rules detecting bugs and suspicious patterns.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 33 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-31 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,429 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-23 styles.
* Styled Components
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 580 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-23 - Linting for JavaScript inside of Markdown.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,804 | 🐛 332 | 🌐 JavaScript | 📅 2026-09-23 - Meteor specific linting rules for ESLint.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,784 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-23 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 620 | 🐛 74 | 🌐 JavaScript | 📅 2026-07-12 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,610 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30.
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 431 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-23 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 250,660 | 🐛 1,373 | 🌐 JavaScript | 📅 2026-09-22 - Linting rules for React Hooks.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 44,021 | 🐛 767 | 🌐 TypeScript | 📅 2026-09-18 - Adds replacements for built-in rules to include Babel features.
...
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 273 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-22 - ESLint plugin for HTML.
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 235 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-23 - An ESLint plugin for linting ESLint plugins.
...
* JSON
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 261 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-23 - Rules for consistent, readable, and valid package.json files.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,946 | 🐛 584 | 🌐 JavaScript | 📅 2026-08-23 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 996 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-23 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 990 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-22 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
...
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 769 | 🐛 83 | 🌐 TypeScript | 📅 2026-09-20 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [eslint-plugin-hex-under](https://github.com/2nd-Labs/eslint-plugin-hex-under) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-22 - A plugin to prove that a hexadecimal number is less than a specified value.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 13 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-23 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,927 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-22 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,064 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-23 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 729 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-23 - Linting rules for Cypress.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,174 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-21 - Linting rules for Jest.
...
* Mocha
  * [Enforcing practices](https://github.com/lo1tuma/eslint-plugin-mocha) ⭐ 289 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-22 - Linting rules for Mocha.
  * [Enforcing manageability](https://github.com/onechiporenko/eslint-plugin-mocha-cleanup/) ⭐ 13 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-20

## Parsers

* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 44,021 | 🐛 767 | 🌐 TypeScript | 📅 2026-09-18 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [esprint](https://github.com/pinterest/esprint) ⭐ 655 | 🐛 26 | 🌐 JavaScript | 📅 2026-04-02 - Run ESLint across multiple threads.
...
* [generator-eslint](https://github.com/eslint/generator-eslint) ⭐ 246 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-23 - Generate ESLint
