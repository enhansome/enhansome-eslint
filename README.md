...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,248 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,248 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,516 | 🐛 129 | 🌐 JavaScript | 📅 2026-09-18 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,262 | 🐛 56 | 🌐 JavaScript | 📅 2026-09-02 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,645 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-19 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,434 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 284 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-19 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,990 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-18.
...
* [Ash-Nazg](https://github.com/brettz9/eslint-config-ash-nazg) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-19 - One config to rule them all!
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 5,246 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-19 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,291 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-20 - Rules detecting bugs and suspicious patterns.
...
* [De Morgan](https://github.com/azat-io/eslint-plugin-de-morgan) ⭐ 317 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-20 - Transforms logical expressions in code to make them easier to understand.
...
* [es-x](https://github.com/eslint-community/eslint-plugin-es-x) ⭐ 156 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-20 - Disable specific ECMAScript language versions or individual features. Properly maintained fork of no longer maintained `eslint-plugin-es`.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,020 | 🐛 395 | 🌐 JavaScript | 📅 2026-08-28 - ESLint rules for emotion.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 33 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-31 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,426 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-27 styles.
* Styled Components
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 581 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-19 - Linting for JavaScript inside of Markdown.
* [HTML](https://github.com/BenoitZugmeyer/eslint-plugin-html) ⭐ 458 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-14 - Linting for JavaScript inside of HTML `<script>` tags.

### Frameworks

* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,806 | 🐛 334 | 🌐 JavaScript | 📅 2026-09-18 - Meteor specific linting rules for ESLint.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,784 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-19 - Linting rules for Angular (v2+).
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 407 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-20 - Linting rules for Svelte v3 Components.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 250,606 | 🐛 1,382 | 🌐 JavaScript | 📅 2026-09-18 - Linting rules for React Hooks.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 44,005 | 🐛 766 | 🌐 TypeScript | 📅 2026-09-18 - Adds replacements for built-in rules to include Babel features.
...
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 303 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-18 - ESLint Parser/Plugin for MDX.
...
* JSON
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 261 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-20 - Rules for consistent, readable, and valid package.json files.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 120 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-20 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 53 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-19 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 840 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-20 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-19 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-19 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,947 | 🐛 582 | 🌐 JavaScript | 📅 2026-08-23 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 996 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-20 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 778 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-20 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 13 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-19 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,927 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-19 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,064 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-19 - Linting rules for Testing Library.
...
* Vitest
  * [ESLint Plugin Vitest](https://github.com/vitest-dev/eslint-plugin-vitest) ⭐ 508 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-19 - ESLint plugin for Vitest.
* Mocha
  * [Enforcing practices](https://github.com/lo1tuma/eslint-plugin-mocha) ⭐ 289 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-20 - Linting rules for Mocha.
  * [Enforcing manageability](https://github.com/onechiporenko/eslint-plugin-mocha-cleanup/) ⭐ 13 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-20

## Parsers

* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 44,005 | 🐛 766 | 🌐 TypeScript | 📅 2026-09-18 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
